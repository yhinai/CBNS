...
HD_PWD='C:/Users/ALHINAI/Documents/GitHub/CBNS/HW_implementation/HW_implementation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log addComplex.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source addComplex.tcl
