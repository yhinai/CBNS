...
HD_PWD='C:/Users/alhinai/GitHub/CBNS/HW_implementation/HW_implementation.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log addComplex.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source addComplex.tcl -notrace
